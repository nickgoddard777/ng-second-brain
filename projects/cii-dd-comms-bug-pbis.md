...
# CII DD Comms Bug PBIs

Create 2 CII bug PBIs for the DD (Direct Debit) Comms Issue — one for posting date, one for masking bank details.
...
- [x] Email Dan and Jiten with PBI list [[cii-dd-comms-email-pbi-list-dan-jiten]] (due: 2026-04-16)

## Notes
- Two bugs in DD Comms: posting date and masking bank details
- DevOps PBIs depend on their respective specs being written first
